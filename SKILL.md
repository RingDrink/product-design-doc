...
description: "通用产品 / 游戏功能设计文档工作流。MUST USE when the user wants to write, rewrite, review, or clarify a product design doc, feature spec, gameplay/system proposal, UX-backed complete spec, or asks to grill/ask questions before writing. Framework-agnostic: default output is portable Markdown; publishing tools, project memory, Figma, and team document platforms are optional adapters."
---

# Product Design Doc

Use this skill to turn a vague feature idea, design discussion, UX source, or existing draft into a readable design document that a product, UX, engineering, or game-dev team can act on.
